...
def main():
    ...
    parser.add_argument('--train_corpus', type=Path, default="../wikitext-103/train.txt")
    parser.add_argument("--output_dir", type=Path, )
    parser.add_argument("--bert_model", type=str, default="/rscratch/sheng.s/model/bert_base/")
    ...
    with DocumentDatabase(reduce_memory=args.reduce_memory) as docs:
        ...
        docs.document_shelf["doc_lengths"] = docs.doc_lengths
        docs.document_shelf["doc_cumsum"] = docs.doc_cumsum
        docs.document_shelf["cumsum_max"] = docs.cumsum_max
