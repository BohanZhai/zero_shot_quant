...
from .quant.quant_modules import QuantLinear, QuantLinear_Act, QuantEmbedding
...
class BertPreTrainedModel(nn.Module):
    ...
    def init_bert_weights(self, module):
        ...
        if isinstance(module, QuantLinear) and module.bias is not None:
            module.bias.data.zero_()
...
class QBertModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        super(QBertModel, self).__init__(config)
