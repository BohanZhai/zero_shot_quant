...
from transformer.modeling_quant import QBertForSequenceClassification, BertConfig
...
def main():
    ...
    default_params = {
        ...
        "rte": {"num_train_epochs": 10, "max_seq_length": 128, "learning_rate": 2e-5, "train_batch_size": 16}
    }
    ...
    student_model = QBertForSequenceClassification.from_pretrained(args.student_model, num_labels=num_labels, quant_config=quant_config)
